...
define("controls/legend", [
    ...
    L.DCI.Controls.Legend = L.Control.extend({
        ...
        */
        ...
        _layerAdd: function (o) {
            ...
            if (this.layers[id] && this.layers[id].lay && this.layers[id].laylabel) {
                ...
                this._requestLegend(id, o.layer.url,o.layer.options.layers);
            }
        },
        ...
        *@private
        */
        _requestLegend: function (id,url,layerIndexArr) {
        ...
        */
        _shwoLegend: function (e) {
            ...
            for (var i = 0; i < legends.length; i++) {
                var label = legends[i].label==""?legends[i].showLabel:legends[i].label;
