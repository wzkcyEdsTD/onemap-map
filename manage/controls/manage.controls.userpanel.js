    ...
    L.DCI.UserPanel = L.Class.extend({
        ...
        */
        getOrganizationTree: function () {
            ...
            L.baseservice.getOrganizationTree({
                    ...
                    else
                    {
                        ...
                        L.baseservice.getDeptUser({
                            ...
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                L.dci.app.util.dialog.alert("温馨提示", "获取所有角色用户失败");
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    L.dci.app.util.dialog.alert("温馨提示", "获取组织机构树失败");
        ...
        */
        defaultAddOrg:function(){
            ...
            L.dci.dialog.dialogModel('addDepartmentModel', 150, 300, html, '添加部门');
        ...
        */
        editOneDepartment: function (treeNode) {
            ...
            L.dci.dialog.dialogModel('editDepartmentModel', 150, 300, html, '编辑部门');
        ...
        */
        deleteOneDepartment: function (treeNode) {
            ...
            L.dci.dialog.dialogModel('deleteDepartmentModel', 150, 300, html, '删除部门');
        ...
        */
        deleteOneUser: function (treeNode) {
            var html = this._layout.deleteDepartmentHtml();
            L.dci.dialog.dialogModel('deleteDepartmentModel', 150, 300, html, '删除用户的部门权限');
            var name = treeNode.name;
        ...
        */
        deleteMoreDeptEvent:function(e){
            var html = this._layout.deleteDepartmentHtml();
            L.dci.dialog.dialogModel('deleteDepartmentModel', 150, 300, html, '批量删除');
            var text = '是否删除勾选的节点?';
            $(".deleteDepartment p").html(text);
        ...
        */
        submitDeleteMoreDept: function (e) {
            ...
            if (nodes.length == 0)
            {
                L.dci.app.util.dialog.alert("温馨提示", "没有选中内容");
        ...
        */
        addUserRole: function (e) {
            ...
            {
                L.dci.app.util.dialog.alert("温馨提示", "组织机构树没有勾选项");
            ...
            else
            {
                ...
                if (Nodes.length > 1)
                {
                    L.dci.app.util.dialog.alert("温馨提示", "只能勾选一个角色");
        ...
        */
        addUserRoleFromUser: function (Node) {
            ...
            if (nodes.length == 0)
            {
                L.dci.app.util.dialog.alert("温馨提示", "没有勾选角色");
                //L.dialog.errorDialogModel("没有勾选角色");
                return;
            }
            for (var i = 0; i < nodes.length; i++)
        ...
        */
        getOAUserEvent: function (e) {
            ...
            L.dci.dialog.dialogModel('oaTipModel', 150, 300, html, '同步OA组织用户');
