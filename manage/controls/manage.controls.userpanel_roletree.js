    ...
    L.DCI.UserPanelRoleTree = L.Class.extend({
        ...
        */
        defaultAddRole:function(){
            ...
            L.dci.dialog.dialogModel('addRoleModel', 150, 300, html, '添加角色');
        ...
        */
        editOneRole: function (treeNode) {
            ...
            L.dci.dialog.dialogModel('editRoleModel', 150, 300, html, '编辑角色');
        ...
        */
        deleteOneRole: function (treeNode) {
            ...
            L.dci.dialog.dialogModel('deleteRoleModel', 150, 300, html, '删除角色');
            var name = treeNode.name;
        ...
        */
        deleteOneUser: function (treeNode) {
            var html = this.userpanel._layout.deleteRoleHtml();
            L.dci.dialog.dialogModel('deleteRoleModel', 150, 300, html, '删除用户的角色权限');
            var name = treeNode.name;
        ...
        */
        deleteMoreRoleEvent: function (e) {
            var html = this.userpanel._layout.deleteRoleHtml();
            L.dci.dialog.dialogModel('deleteRoleModel', 150, 300, html, '批量删除');
            var text = '是否删除勾选的角色?';
            $(".deleteRole p").html(text);
        ...
        */
        submitDeleteMoreRole: function (e) {
            ...
            {
                L.dci.app.util.dialog.alert("温馨提示", "没有选中角色");
