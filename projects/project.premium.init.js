...
var Default_Paths = {
	...
	//"library/layer": "../library/layer/layer",
	
    "rqtext": '../library/requirejs/text',
    "vue": '../library/vue/vue.min',
    ...
    "layui/layui": '../library/layui/layui',
    ...
    "query/spatialIdentify": '../modules/query/query.spatialIdentify',
    ...
    "analysis/certificate": '../modules/analysis/analysis.certificate',
	"analysis/greenSpaceAnalysis": '../modules/analysis/analysis.greenSpaceAnalysis',

    "analysis/auxiliaryloc": '../modules/analysis/analysis.auxiliaryloc',
    ...
    //"leaflet/heatmap": '../library/leaflet/heatmap/webgl-heatmap',
    //"leaflet/leafletheatmap": '../library/leaflet/heatmap/webgl-heatmap-leaflet'
};
...
var Default_Shims = {
    ...
    "analysis/certificate": { deps: ['plugins/scrollbar', 'css!../../themes/' + Base_ParamConfig.defaultTheme + '/css/analysis.certificate.css'] },
    "analysis/conflictanalysis": { deps: ['plugins/scrollbar', 'css!../../themes/' + Base_ParamConfig.defaultTheme + '/css/analysis.conflictanalysis.css'] },
	...
	//"plugins/datetimepicker": { deps: ['css!../../plugins/datetimepicker-master/jquery.datetimepicker.css'] },
    ...
    "leafletHeat": { deps: ['leaflet', 'leaflet/esri'] },

    //"leaflet/heatmap": { deps: ['jquery', 'leaflet', 'leaflet/esri'] },
    //"leaflet/leafletheatmap": { deps: ['leaflet', 'leaflet/esri', 'leaflet/heatmap'] },
    ...
    //"jqGrid": { deps: ['css!../library/jqGrid_JS_5.1.1/css/ui.jqgrid-bootstrap.css'] },
}
