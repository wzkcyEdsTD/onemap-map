...
var Project_ParamConfig = {
    ...
    */
	//綠地變化分析
    getGreenChangeArea: "http://192.168.39.41/GGSS/JGSP/MaintainManage/getGreenChangeArea",
    ...
    *@type {Object}
    */
    dmdzLayers: "http://192.168.39.40:6080/arcgis/rest/services/kfqsz/address/MapServer",
    /**
    *地名地址服务地址设置
    *@property dmdzLayers
    *@type {Object}
    */
    ldbhfxLayers: "http://192.168.39.40:6080/arcgis/rest/services/kfqsz/LDBHFX/MapServer",
    /**
    *浏览版专题图服务地址设置
    *@property bmapLayers
    *@type {Object}
    ...
    timeLayers: [
	{
        id: 'yx', name: '历史影像', layers: [
           { year: 2005, layerType: 1, url: 'http://' + UrlConfig.IP2 + '/arcgis/rest/services/basemap/kfqhis_2005/MapServer' },
			...
			{ year: 2011, layerType: 1, url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/basemap/kfqhis_2011/MapServer'},
            { year: 2012, layerType: 1, url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/basemap/kfqhis_2012/MapServer'},
			{ year: 2014, layerType: 1, url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/basemap/kfq_yxwz2000/MapServer'}
        ]
	}
	],
    /**
