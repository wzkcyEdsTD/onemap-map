...
var Project_ParamConfig = {
    ...
    */
    crs: {
        ...
        *@type {String}
        */
		 code: 'PROJCS["wenzhou2000",GEOGCS["GCS_China_Geodetic_Coordinate_System_2000",DATUM["D_China_2000",SPHEROID["CGCS2000",6378137.0,298.257222101]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Transverse_Mercator"],PARAMETER["false_easting",500000.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",120.666666666667],PARAMETER["scale_factor",1.0],PARAMETER["latitude_of_origin",0.0],UNIT["Meter",1.0]]',
        ...
        //code: 'EPSG: {"wks": "PROJCS["wenzhou_Gauss",GEOGCS["GCS_Beijing_1954",DATUM["D_Beijing_1954",SPHEROID["Krasovsky_1940",6378245.0,298.3]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Gauss_Kruger"],PARAMETER["False_Easting",500000.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",120.666666666667],PARAMETER["Scale_Factor",1.0],PARAMETER["Latitude_Of_Origin",0.0],UNIT["Meter",1.0]]"}',
    ...
    */
    baseLayer: {
        ...
        */
        ...
        url: 'http://' + UrlConfig.IP2 + '/arcgis/rest/services/kfq_csgl/ggss_sl_wz2000/MapServer',
        /**
        *原点
        *@property origin
        *@type {Array}
        ...
        *@type {Array}
        */
        //fullextent: [507404.8107015664, 3078484.017104641, 517379.6223178563, 3083947.673865288],
        fullextent: [482703.1784388339, 3062465.9152846113, 539999.733103727, 3118676.116611773],
        /**
        *切片图片大小
        *@property tileSize
         *@type {Number}
    ...
    changeLayers: [
        {
            ...
            origin: [-5123200.0, 1.00021E7],
            url: 'http://' + UrlConfig.IP2 + '/arcgis/rest/services/kfq_csgl/ggss_yx_wz2000/MapServer'
        },
        {
            id: 'baseLayer-dx',//25维
            name: '25维',
            ...
            tileSize: 256,
            origin: [-5123300.0, 1.00023E7],
            url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/kfq_csgl/ggss_2_5D_wz2000/MapServer'
        }
    ],
    projectLayer: [
        {
    ...
    */
    timeLayers: [
	{
        id: 'yx', name: '历史影像', layers: [
            { year: 2005, layerType: 1, url: 'http://' + UrlConfig.IP2 + '/arcgis/rest/services/kfq_csgl/ggss_yx_wz2000/MapServer' },
            { year: 2010, layerType: 1, url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/kfq_csgl/ggss_2_5D_wz2000/MapServer'}
