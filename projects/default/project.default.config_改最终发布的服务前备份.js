    ...
    */
    changeLayers: [
        ...
        },
        {
            ...
            tileSize: 256,
            origin: [-5123300.0, 1.00023E7],
            url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/kfq_csgl/25D_wz2000/MapServer'
        }
    ],
    projectLayer: [
        {
    ...
    */
    timeLayers: [
	{
        id: 'yx', name: '历史影像', layers: [
            { year: 2009, layerType: 1, url: 'http://' + UrlConfig.IP2 + '/arcgis/rest/services/kfq_csgl/yx_wz2000/MapServer' },
            { year: 2011, layerType: 1, url: 'http://'+ UrlConfig.IP2+'/arcgis/rest/services/kfq_csgl/szpt_wz3q_2_5D/MapServer'}
