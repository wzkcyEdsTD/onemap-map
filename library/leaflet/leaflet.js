        ...
        _update: function () {
            ...
            if (this.options.origin) {
                ...
                if (mapOrigin[0] != layerOrigin[0] || mapOrigin[1] != layerOrigin[1]) {
                    var min = this._map.options.crs.pointToLatLng(bounds.min, zoom);
                    var max = this._map.options.crs.pointToLatLng(bounds.max, zoom);
                    ...
                    bounds.min = crs.latLngToPoint(min, zoom);
                    bounds.max = crs.latLngToPoint(max, zoom);
                }
            }
