       ...
       */
        ...
        */
        find: function (key) {
            ...
            L.dci.app.services.queryService.queryByKey({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "无查询结果");
                }
            });
        },
        /**
        ...
        */
        query: function (key) {
            ...
            try
            {
                ...
                L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
        ...
        */
        _qqGetData: function (currentPage, maxShowNum, condition) {
            ...
            L.dci.app.services.businessService.queryQuery({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.error("温馨提示", "未找到该项目");
                    return;
                }
            });
            //编制
            ...
            L.dci.app.services.businessService.getCompileMapPageData({
                ...
                error: function (e) {
                    //L.dci.app.util.dialog.error("温馨提示", e.statusText);
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                }
            });
            ...
            L.dci.app.services.businessService.getProjectmapManageCells({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                    //L.dci.app.util.dialog.error("温馨13提示", e.statusText);
                }
            });
            ...
            L.dci.app.services.businessService.getApprovedTrackingData({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                    //L.dci.app.util.dialog.error("温馨14提示", e.statusText);
                }
            });
            //
        ...
        */
        _bzGetData: function (currentPage, maxShowNum, status, condition) {
            ...
            L.dci.app.services.businessService.getCompileMapPageData({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                    //L.dci.app.util.dialog.error("温馨15提示", e.statusText);
                }
            });
        },
        ...
        */
        _xmGetData: function (currentPage, maxShowNum, phase, condition) {
            L.dci.app.services.businessService.getProjectmapManageCells({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                    //L.dci.app.util.dialog.error("温馨16提示", e.statusText);
                }
            });
        },
        ...
        */
        _phGetData: function (currentPage, maxShowNum, region, stage, condition) {
            ...
            L.dci.app.services.businessService.getApprovedTrackingData({
                ...
                error: function (e) {
                    L.dci.app.util.dialog.alert("温馨提示", "未找到该项目");
                    //L.dci.app.util.dialog.error("温馨17提示", e.statusText);
                }
            });
        },
        /**
        ...
        */
        _viewPhaseProject: function (e) {
            ...
            if (id == "" || id == undefined)
                L.dci.app.util.dialog.alert("温馨提示", '未能找到该项目');
            else
                L.dci.app.util.tool.autoLogin(id);
        },
        ...
        */
        queryProjectLatlng: function (projectId, projectPhase, projectType) {
            ...
            query.run(function (error, featureCollection, response) {
                if (error) {
                    L.dci.app.util.dialog.alert("温馨提示","项目一张图图层加载错误");
                    //L.dci.app.util.dialog.alert("温馨提示"+ error.code, "详情:" + error.message);
                }
                else {
        ...
        */
        _doQuery: function (field, id, layer, layerIndex) {
            ...
            query.run(function (error, featureCollection, response) {
                if (error) {
                    L.dci.app.util.dialog.alert("温馨提示","图层定位发生错误");
                    //L.dci.app.util.dialog.alert("温馨提示", "代码:" + error.code, "详情:" + error.message);
                } else {
