        ...
        */
        ...
        createToolInputContent: function (name, eleObj) {
			...
			html += '<div class="row" style="width: 400px;margin-top: 10px;">'
				...
				+'</div>';
				/*
            html += '<form><div class="form-group" style="width:90%;">'
                        +'<label class="control-label" for="projectName">项目名称</label>'
                        +'<input type="text" class="form-control" id="projectName"/>'
						 +'<label class="control-label" for="datetimepicker1">建设时间</label>'
                            +'<input id="d11" type="text" onClick="WdatePicker()"/>'
							 +'<input id="d11" type="text" onClick="WdatePicker()"/>'
                      + '</div>'
            + '<button type="button" id="ProjectQuery" class="btn btn-default" style=" position: relative;left: 110px;">查询</button></form>';*/
            //弹出工具盒
