...
define("login/settings", [
    ...
    L.DCI.LoginSettings = L.Class.extend({
        ...
        */
        uploadstr: function(str) {
            ...
            _dciAjax.get(_url, null, true, null, function() {
                L.dci.app.util.dialog.alert("提示", "修改头像成功");
                ...
                L.dci.app.util.dialog.alert("提示", "修改头像失败");
            });
        },
        /**
        *上传头像图片
                ...
                success: function(str) {
                    if (str != null && str != "undefined") {
                        if (str != "2" || str != "3" || str != "4") {
                            ...
                            L.dci.app.util.dialog.alert("只能上传jpg格式的图片");
                        } else if (str == "3") {
                            L.dci.app.util.dialog.alert("图片不能大于1M");
                        } else if (str == "4") {
                            L.dci.app.util.dialog.alert("请选择要上传的文件");
                        } else {
                            alert('操作失败');
                        }
                    } else alert('操作失败');
        ...
        */
        _error: function() {
            L.dci.app.util.dialog.alert('提示', '修改密码请求失败，请重试');
        },
        /**
        *文件选择
        *@method fileSelected
