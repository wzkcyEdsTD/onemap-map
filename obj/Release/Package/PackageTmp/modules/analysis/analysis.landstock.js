        ...
        getTabsData1: function () {
            ...
            L.dci.app.services.baseService.getXingzheng({
                ...
                success: function (res) {
                    this.tabsData1 = null;
                    this.tabsData1 = {
                        "district": Project_ParamConfig.landuseStockConfig.xzqh,
                        "towns": [
                        ]
                    };
                    for (var rn in res) {
        ...
        */
        clickLiEvent: function (e) {
            ...
            if (bool != -1) {
                ...
                this.text = Project_ParamConfig.landuseStockConfig.xingzheng_layer.districtValue;
            ...
            //查询行政边界
            var currentData = [];
            var url = Project_ParamConfig.landuseStockConfig.xingzheng_layer.url;
            var id = Project_ParamConfig.landuseStockConfig.xingzheng_layer.field;
            var layerIndex = Project_ParamConfig.landuseStockConfig.xingzheng_layer.layerIndex;
            var query = new L.esri.Tasks.find(url);
            query.params.sr = Project_ParamConfig.landuseStockConfig.xingzheng_layer.sr;
