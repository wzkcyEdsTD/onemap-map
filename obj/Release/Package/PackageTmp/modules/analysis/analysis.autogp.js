    ...
    L.DCI.AutoGP = L.Class.extend({
        ...
        getDivisions: function () {
            ...
            L.dci.app.services.baseService.getXingzheng({
                ...
                success: function (res) {
                    ...
                    _this.presult.push({ name: Project_ParamConfig.ydphfxConfig.xingzheng_layer.districtValue, region: '', landb_result: '', lands_result: '', landst_result: '', landpu_result: '', });
       ...
       */
        doPre: function () {
            ...
            var field = Project_ParamConfig.ydphfxConfig.xingzheng_layer.field;
            var text = this.presult[this.num].name;
            var layerIndex = "1";

            var find = new L.esri.Tasks.find(url);
            find.layers(layerIndex).text(text).fields(field);
            find.params.sr = Project_ParamConfig.ydphfxConfig.xingzheng_layer.sr;
