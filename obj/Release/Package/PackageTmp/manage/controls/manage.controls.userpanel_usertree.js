    ...
    L.DCI.UserPanelUserTree = L.Class.extend({
        ...
        */
        defaultAddUser:function(e){
            ...
            L.dialog.dialogModel('addUserModel', 150, 350, html, '添加用户');
        ...
        */
        editOneUser: function (treeNode) {
            ...
            L.dialog.dialogModel('editUserModel', 150, 350, html, '编辑用户');
        ...
        */
        deleteOneUser: function (treeNode) {
            ...
            L.dialog.dialogModel('deleteUserModel', 150, 300, html, '删除用户');
        ...
        */
        deleteMoreUserEvent: function (e) {
            var html = this.userpanel._layout.deleteUserHtml();
            L.dialog.dialogModel('deleteUserModel', 150, 300, html, '批量删除');
            var text = '是否删除勾选的用户?';
            $(".deleteUser p").html(text);
