...
*加载提示控件
*@module controls
*@class DCI.Controls.Loading
*@extends L.Control
*/
define("controls/loading", [
    "leaflet",
    "core/dcins"
], function (L) {
    L.DCI.Controls.Loading = L.Control.extend({
        options: {
            position: 'topleft',
            separate: false,
            zoomControl: null,
    ...
    L.dci.loading = function(options) {
        return new L.DCI.Controls.Loading(options);
    };
});
