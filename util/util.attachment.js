                    ...
                    switch (thisType) {
                        ...
                        case "caseFolder":
                            ...
                            L.dci.app.services.utilService.dlFolder({
                                ...
                                error: function () {
                                    L.dci.app.util.dialog.alert("温馨提示", "文件打包失败");
            ...
            L.dci.app.services.utilService.getoaAttachment({
                ...
                success: function (business) {
                    ...
                    if (data.length != 0) {
                        ...
                        L.dci.app.util.dialog.alert("温馨提示", "未能找到该项目附件");
                    }
                },
                error: function (e) {//"获取OA附件目录树"
                    L.dci.app.util.dialog.alert("温馨提示", "获取OA附件目录树失败");
                }
            });
            //return attObject;
        },
